...
; NONE-SAME: (ptr noalias captures(none) [[A:%.*]], ptr noalias readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; NONE-NEXT:  entry:
...
; SCOPES-SAME: (ptr noalias captures(none) [[A:%.*]], ptr noalias readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; SCOPES-NEXT:  entry:
...
; SCOPES-NEXT:    [[TMP0:%.*]] = load float, ptr [[C]], align 4, !alias.scope [[META3]], !noalias [[META0]]
; SCOPES-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[A]], i64 5
; SCOPES-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX_I]], align 4, !alias.scope [[META0]], !noalias [[META3]]
...
; FULL-SAME: (ptr noalias captures(none) [[A:%.*]], ptr noalias readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; FULL-NEXT:  entry:
...
; FULL-NEXT:    [[TMP4:%.*]] = load float, ptr [[TMP3]], align 4, !noalias [[META3]]
; FULL-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[TMP1]], i64 5
; FULL-NEXT:    store float [[TMP4]], ptr [[ARRAYIDX_I]], align 4, !noalias [[META3]]
...
; NONE-SAME: (ptr captures(none) [[A:%.*]], ptr captures(none) [[B:%.*]], ptr readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; NONE-NEXT:  entry:
; NONE-NEXT:    [[TMP0:%.*]] = load float, ptr [[C]], align 4
...
; SCOPES-SAME: (ptr captures(none) [[A:%.*]], ptr captures(none) [[B:%.*]], ptr readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; SCOPES-NEXT:  entry:
...
; SCOPES-NEXT:    [[TMP0:%.*]] = load float, ptr [[C]], align 4, !alias.scope [[META15:![0-9]+]], !noalias [[META16:![0-9]+]]
; SCOPES-NEXT:    [[ARRAYIDX_I_I:%.*]] = getelementptr inbounds float, ptr [[A]], i64 5
; SCOPES-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX_I_I]], align 4, !alias.scope [[META16]], !noalias [[META15]]
; SCOPES-NEXT:    [[TMP1:%.*]] = load float, ptr [[C]], align 4, !alias.scope [[META8]], !noalias [[META5]]
; SCOPES-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[A]], i64 7
; SCOPES-NEXT:    store float [[TMP1]], ptr [[ARRAYIDX_I]], align 4, !alias.scope [[META5]], !noalias [[META8]]
...
; SCOPES-NEXT:    [[TMP2:%.*]] = load float, ptr [[C]], align 4, !noalias [[META22:![0-9]+]]
; SCOPES-NEXT:    [[ARRAYIDX_I1:%.*]] = getelementptr inbounds float, ptr [[A]], i64 6
; SCOPES-NEXT:    store float [[TMP2]], ptr [[ARRAYIDX_I1]], align 4, !alias.scope [[META17]], !noalias [[META20]]
; SCOPES-NEXT:    [[ARRAYIDX1_I:%.*]] = getelementptr inbounds float, ptr [[B]], i64 8
; SCOPES-NEXT:    store float [[TMP2]], ptr [[ARRAYIDX1_I]], align 4, !alias.scope [[META20]], !noalias [[META17]]
...
; FULL-SAME: (ptr captures(none) [[A:%.*]], ptr captures(none) [[B:%.*]], ptr readonly captures(none) [[C:%.*]]) #[[ATTR0]] {
; FULL-NEXT:  entry:
...
; FULL-NEXT:    [[TMP4:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META12:![0-9]+]]), !noalias [[META9]]
; FULL-NEXT:    [[TMP5:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP1]], ptr [[TMP4]], ptr null, i64 0, metadata [[META12]]), !noalias [[META15:![0-9]+]]
; FULL-NEXT:    [[TMP6:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META17:![0-9]+]]), !noalias [[META9]]
; FULL-NEXT:    [[TMP7:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr readonly [[TMP3]], ptr [[TMP6]], ptr null, i64 0, metadata [[META17]]), !noalias [[META15]]
; FULL-NEXT:    [[TMP8:%.*]] = load float, ptr [[TMP7]], align 4, !noalias [[META15]]
; FULL-NEXT:    [[ARRAYIDX_I_I:%.*]] = getelementptr inbounds float, ptr [[TMP5]], i64 5
; FULL-NEXT:    store float [[TMP8]], ptr [[ARRAYIDX_I_I]], align 4, !noalias [[META15]]
; FULL-NEXT:    [[TMP9:%.*]] = load float, ptr [[TMP3]], align 4, !noalias [[META9]]
; FULL-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[TMP1]], i64 7
; FULL-NEXT:    store float [[TMP9]], ptr [[ARRAYIDX_I]], align 4, !noalias [[META9]]
; FULL-NEXT:    [[TMP10:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META18:![0-9]+]])
; FULL-NEXT:    [[TMP11:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[A]], ptr [[TMP10]], ptr null, i64 0, metadata [[META18]]), !noalias [[META21:![0-9]+]]
; FULL-NEXT:    [[TMP12:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META23:![0-9]+]])
; FULL-NEXT:    [[TMP13:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[B]], ptr [[TMP12]], ptr null, i64 0, metadata [[META23]]), !noalias [[META21]]
; FULL-NEXT:    [[TMP14:%.*]] = load float, ptr [[C]], align 4, !noalias [[META21]]
; FULL-NEXT:    [[ARRAYIDX_I1:%.*]] = getelementptr inbounds float, ptr [[TMP11]], i64 6
; FULL-NEXT:    store float [[TMP14]], ptr [[ARRAYIDX_I1]], align 4, !noalias [[META21]]
; FULL-NEXT:    [[ARRAYIDX1_I:%.*]] = getelementptr inbounds float, ptr [[TMP13]], i64 8
; FULL-NEXT:    store float [[TMP14]], ptr [[ARRAYIDX1_I]], align 4, !noalias [[META21]]
