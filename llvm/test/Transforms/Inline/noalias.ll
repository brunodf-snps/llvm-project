...
; SCOPES-NEXT:    [[TMP0:%.*]] = load float, ptr [[C:%.*]], align 4, !noalias [[META0]]
; SCOPES-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[A:%.*]], i64 5
; SCOPES-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX_I]], align 4, !alias.scope [[META0]]
...
; FULL-NEXT:    [[TMP1:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[A:%.*]], ptr [[TMP0]], ptr null, i64 0, metadata [[META0]]), !noalias [[META0]]
; FULL-NEXT:    [[TMP2:%.*]] = load float, ptr [[C:%.*]], align 4, !noalias [[META0]]
; FULL-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[TMP1]], i64 5
; FULL-NEXT:    store float [[TMP2]], ptr [[ARRAYIDX_I]], align 4, !noalias [[META0]]
...
; SCOPES-NEXT:    [[TMP0:%.*]] = load float, ptr [[C:%.*]], align 4, !noalias [[META8:![0-9]+]]
; SCOPES-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[A:%.*]], i64 5
; SCOPES-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX_I]], align 4, !alias.scope [[META3]], !noalias [[META6]]
; SCOPES-NEXT:    [[ARRAYIDX1_I:%.*]] = getelementptr inbounds float, ptr [[B:%.*]], i64 8
; SCOPES-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX1_I]], align 4, !alias.scope [[META6]], !noalias [[META3]]
; SCOPES-NEXT:    [[TMP1:%.*]] = load float, ptr [[C]], align 4
; SCOPES-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[A]], i64 7
; SCOPES-NEXT:    store float [[TMP1]], ptr [[ARRAYIDX]], align 4
; SCOPES-NEXT:    ret void
...
; FULL-NEXT:    [[TMP1:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[A:%.*]], ptr [[TMP0]], ptr null, i64 0, metadata [[META3]]), !noalias [[META6:![0-9]+]]
; FULL-NEXT:    [[TMP2:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META8:![0-9]+]])
; FULL-NEXT:    [[TMP3:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[B:%.*]], ptr [[TMP2]], ptr null, i64 0, metadata [[META8]]), !noalias [[META6]]
; FULL-NEXT:    [[TMP4:%.*]] = load float, ptr [[C:%.*]], align 4, !noalias [[META6]]
; FULL-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds float, ptr [[TMP1]], i64 5
; FULL-NEXT:    store float [[TMP4]], ptr [[ARRAYIDX_I]], align 4, !noalias [[META6]]
; FULL-NEXT:    [[ARRAYIDX1_I:%.*]] = getelementptr inbounds float, ptr [[TMP3]], i64 8
; FULL-NEXT:    store float [[TMP4]], ptr [[ARRAYIDX1_I]], align 4, !noalias [[META6]]
