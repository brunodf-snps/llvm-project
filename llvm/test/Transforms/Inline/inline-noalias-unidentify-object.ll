...
; CHECK_SCOPES-LABEL: define i32 @caller(ptr %p) {
; CHECK_SCOPES-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata [[META0:![0-9]+]])
; CHECK_SCOPES-NEXT:    [[P_11_I:%.*]] = getelementptr i8, ptr %p, i64 11
; CHECK_SCOPES-NEXT:    [[V_I:%.*]] = load i32, ptr [[P_11_I]], align 4, !alias.scope !0
...
; CHECK_SCOPES-NEXT:    [[P_7_I1:%.*]] = getelementptr i8, ptr [[P_6_I]], i64 1
; CHECK_SCOPES-NEXT:    [[P_8_I:%.*]] = getelementptr i8, ptr [[P_7_I1]], i64 1
; CHECK_SCOPES-NEXT:    [[P_9_I:%.*]] = getelementptr i8, ptr [[P_8_I]], i64 1
; CHECK_SCOPES-NEXT:    [[P_7_I:%.*]] = getelementptr i8, ptr [[P_9_I]], i64 1
...
;
; CHECK_FULL-LABEL: define i32 @caller(ptr %p) {
...
; CHECK_FULL-NEXT:    [[P_11_I:%.*]] = getelementptr i8, ptr [[TMP2]], i64 11
; CHECK_FULL-NEXT:    [[V_I:%.*]] = load i32, ptr [[P_11_I]], align 4, !noalias !0
...
; CHECK_FULL-NEXT:    [[P_8_I:%.*]] = getelementptr i8, ptr [[P_7_I]], i64 1
; CHECK_FULL-NEXT:    [[P_9_I:%.*]] = getelementptr i8, ptr [[P_8_I]], i64 1
; CHECK_FULL-NEXT:    [[P_10_I:%.*]] = getelementptr i8, ptr [[P_9_I]], i64 1
; CHECK_FULL-NEXT:    [[P_11_ALIAS_I:%.*]] = getelementptr i8, ptr [[P_10_I]], i64 1
; CHECK_FULL-NEXT:    store i32 42, ptr [[P_11_ALIAS_I]], align 4, !noalias !0
