...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %2 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !13)
; CHECK:  %3 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !13)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %l2_fum.sroa.0.0.l2_fum.sroa.0.0.copyload.noalias, ptr %2, ptr null, i64 0, metadata !13), !tbaa !15, !noalias !18
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %4 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !21)
; CHECK:  %5 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !21)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %l3_fum.sroa.5.0.l3_fum.sroa.5.0.copyload.noalias, ptr %5, ptr null, i64 4, metadata !21), !tbaa !23, !noalias !24
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK: ret void
...
; CHECK-NOT: alloca
; CHECK:  %0 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !28)
; CHECK:  %1 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !28)
; CHECK:  %tmp3 = call ptr @llvm.noalias.copy.guard.p0.p0(ptr %a_fum, ptr null, metadata !30, metadata !25)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp1.fca.0.[[GEP5:gep[0-9]+]] = getelementptr inbounds %struct.FUM, ptr %a_fum, i32 0, i32 0
; CHECK:  %cp1.fca.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.0.load, ptr null, ptr %cp1.fca.0.[[GEP5]], i64 0, metadata !25)
; CHECK:  %cp1.fca.1.0.[[GEP6:gep[0-9]+]] = getelementptr inbounds %struct.FUM, ptr %a_fum, i32 0, i32 1, i32 0
; CHECK:  %cp1.fca.1.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.1.0.load, ptr null, ptr %cp1.fca.1.0.[[GEP6]], i64 0, metadata !25)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %2 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !33)
; CHECK:  %3 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !33)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp2.fca.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.0.extract, ptr %0, ptr null, i64 0, metadata !28)
; CHECK:  %cp2.fca.1.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.1.0.extract, ptr %1, ptr null, i64 4, metadata !28)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp2.fca.{{.*}}.extract, ptr %2, ptr null, i64 0, metadata !33), !tbaa !15, !noalias !35
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %4 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !36)
; CHECK:  %5 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !36)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp3.fca.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.0.extract, ptr %0, ptr null, i64 0, metadata !28)
; CHECK:  %cp3.fca.1.0.load.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %cp1.fca.1.0.extract, ptr %1, ptr null, i64 4, metadata !28)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %{{cp3|cp2}}.fca.1.0.extract, ptr %5, ptr null, i64 4, metadata !36), !tbaa !23, !noalias !38
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  ret void
...
; CHECK-NOT: alloca
; CHECK:  %0 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !42)
; CHECK:  %1 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !42)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %{{cp1[0-9]*}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %{{cp1[0-9]*}}.sroa_as_ptr, ptr null, ptr %2, i64 0, metadata !39)
; CHECK:  %{{cp1[0-9]*}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %{{cp1[0-9]*}}.sroa_as_ptr, ptr null, ptr %tmp5.sroa_idx, i64 0, metadata !39)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %5 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !44)
; CHECK:  %6 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !44)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK_S:  %cp21.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %3, ptr %0, ptr null, i64 0, metadata !42)
; CHECK_S:  %cp22.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %4, ptr %1, ptr null, i64 4, metadata !42)
; CHECK:  %{{cp2[0-9]+}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %3, ptr %0, ptr null, i64 0, metadata !42)
; CHECK:  %{{cp2[0-9]+}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %4, ptr %1, ptr null, i64 4, metadata !42)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %7, ptr %5, ptr null, i64 0, metadata !44), !tbaa !15, !noalias !46
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %9 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata !47)
; CHECK:  %10 = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 4, metadata !47)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %{{cp3[0-9]*}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %3, ptr %0, ptr null, i64 0, metadata !42)
; CHECK:  %{{cp3[0-9]*}}.sroa_as_ptr.noalias = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %4, ptr %1, ptr null, i64 4, metadata !42)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call ptr @llvm.noalias.p0.p0.p0.i64(ptr %12, ptr %10, ptr null, i64 4, metadata !47), !tbaa !23, !noalias !49
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  ret void
...
; CHECK:  !8 = !{!9, !9, i64 0}
; CHECK:  !9 = !{!"any pointer", !10, i64 0}
; CHECK:  !10 = !{!"omnipotent char", !11, i64 0}
; CHECK:  !11 = !{!"Simple C/C++ TBAA"}
; CHECK:  !12 = !{!7, !4}
; CHECK:  !13 = !{!14}
; CHECK:  !14 = distinct !{!14, !5, !"test01_memcpy: l2_fum"}
; CHECK:  !15 = !{!16, !9, i64 0}
; CHECK:  !16 = !{!"FUM", !9, i64 0, !17, i64 4}
; CHECK:  !17 = !{!"FOO", !9, i64 0}
; CHECK:  !18 = !{!14, !7, !4}
; CHECK:  !19 = !{!20, !20, i64 0}
; CHECK:  !20 = !{!"int", !10, i64 0}
; CHECK:  !21 = !{!22}
; CHECK:  !22 = distinct !{!22, !5, !"test01_memcpy: l3_fum"}
; CHECK:  !23 = !{!16, !9, i64 4}
; CHECK:  !24 = !{!22, !7, !4}
; CHECK:  !25 = !{!26}
; CHECK:  !26 = distinct !{!26, !27, !"test02_aggloadstore: unknown scope"}
; CHECK:  !27 = distinct !{!27, !"test02_aggloadstore"}
; CHECK:  !28 = !{!29}
; CHECK:  !29 = distinct !{!29, !27, !"test02_aggloadstore: l_fum"}
; CHECK:  !30 = !{i64 8, i64 0, !31, i64 1}
; CHECK:  !31 = !{i64 8, i64 0, i64 4, i64 1, i64 4, !32, i64 1}
; CHECK:  !32 = !{i64 4, i64 0, i64 4, i64 1}
; CHECK:  !33 = !{!34}
; CHECK:  !34 = distinct !{!34, !27, !"test02_aggloadstore: l2_fum"}
; CHECK:  !35 = !{!34, !29, !26}
; CHECK:  !36 = !{!37}
; CHECK:  !37 = distinct !{!37, !27, !"test02_aggloadstore: l3_fum"}
; CHECK:  !38 = !{!37, !29, !26}
; CHECK:  !39 = !{!40}
; CHECK:  !40 = distinct !{!40, !41, !"test03_i64loadstore: unknown scope"}
; CHECK:  !41 = distinct !{!41, !"test03_i64loadstore"}
; CHECK:  !42 = !{!43}
; CHECK:  !43 = distinct !{!43, !41, !"test03_i64loadstore: l_fum"}
; CHECK:  !44 = !{!45}
; CHECK:  !45 = distinct !{!45, !41, !"test03_i64loadstore: l2_fum"}
; CHECK:  !46 = !{!45, !43, !40}
; CHECK:  !47 = !{!48}
; CHECK:  !48 = distinct !{!48, !41, !"test03_i64loadstore: l3_fum"}
; CHECK:  !49 = !{!48, !43, !40}
