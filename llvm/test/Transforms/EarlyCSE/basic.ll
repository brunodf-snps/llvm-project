...
; CHECK-LABEL: @test2b(
define i32 @test2b(ptr %P, i1 %b) {
  %V1 = load i32, ptr %P
  call ptr @llvm.noalias.p0.p0.p0.i32(ptr undef, ptr null, ptr null, i32 0, metadata !1)
  %V2 = load i32, ptr %P
  %Diff = sub i32 %V1, %V2
  ret i32 %Diff
  ; CHECK: ret i32 0
...
; CHECK-LABEL: @test2c(
define i32 @test2c(ptr %P, i1 %b) {
  %V1 = load i32, ptr %P
  call ptr @llvm.provenance.noalias.p0.p0.p0.p0.i32(ptr undef, ptr null, ptr null, ptr null, i32 0, metadata !1)
  %V2 = load i32, ptr %P
  %Diff = sub i32 %V1, %V2
  ret i32 %Diff
  ; CHECK: ret i32 0
...
; CHECK-LABEL: @test6b(
define i32 @test6b(ptr %P, i1 %b) {
  store i32 42, ptr %P
  call ptr @llvm.noalias.p0.p0.p0.i32(ptr undef, ptr null, ptr null, i32 0, metadata !3)
  %V1 = load i32, ptr %P
  ret i32 %V1
  ; CHECK: ret i32 42
}
...
; CHECK-LABEL: @test6c(
define i32 @test6c(ptr %P, i1 %b) {
  store i32 42, ptr %P
  call ptr @llvm.provenance.noalias.p0.p0.p0.p0.i32(ptr undef, ptr null, ptr null, ptr null, i32 0, metadata !3)
  %V1 = load i32, ptr %P
  ret i32 %V1
  ; CHECK: ret i32 42
}
