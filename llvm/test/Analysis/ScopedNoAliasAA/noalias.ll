...
entry:
  ...
  %0 = load float, ptr %c, align 4, !noalias !0
  ...
  store float %1, ptr %arrayidx, align 4, !noalias !0
  ret void
}

; CHECK-LABEL: Function: foo:
; CHECK: NoAlias:   %0 = load float, ptr %c, align 4, !noalias !0 <->   store float %0, ptr %arrayidx.i, ptr_provenance ptr %prov.a, align 4, !noalias !0
; CHECK: MayAlias:   %0 = load float, ptr %c, align 4, !noalias !0 <->   store float %1, ptr %arrayidx, align 4, !noalias !0
; CHECK: MayAlias:   %1 = load float, ptr %c, align 4 <->   store float %0, ptr %arrayidx.i, ptr_provenance ptr %prov.a, align 4, !noalias !0
; CHECK: MayAlias:   %1 = load float, ptr %c, align 4 <->   store float %1, ptr %arrayidx, align 4, !noalias !0
; CHECK: NoAlias:   store float %1, ptr %arrayidx, align 4, !noalias !0 <->   store float %0, ptr %arrayidx.i, ptr_provenance ptr %prov.a, align 4, !noalias !0
...
entry:
  ...
  %2 = load float, ptr %c, align 4, !noalias !8
  ...
  %arrayidx = getelementptr inbounds float, ptr %a, i64 %i1
  store float %3, ptr %arrayidx, align 4, !noalias !8
  ret void
}

; CHECK-LABEL: Function: foo2:
; CHECK: NoAlias:   %2 = load float, ptr %c, align 4, !noalias !5 <->   store float %2, ptr %arrayidx.i, ptr_provenance ptr %0, align 4, !noalias !5
; CHECK: NoAlias:   %2 = load float, ptr %c, align 4, !noalias !5 <->   store float %2, ptr %arrayidx1.i, ptr_provenance ptr %1, align 4, !noalias !5
; CHECK: MayAlias:   %2 = load float, ptr %c, align 4, !noalias !5 <->   store float %3, ptr %arrayidx, align 4, !noalias !5
...
; CHECK: MayAlias:   %3 = load float, ptr %c, align 4 <->   store float %3, ptr %arrayidx, align 4, !noalias !5
...
; CHECK: NoAlias:   store float %3, ptr %arrayidx, align 4, !noalias !5 <->   store float %2, ptr %arrayidx1.i, ptr_provenance ptr %1, align 4, !noalias !5
