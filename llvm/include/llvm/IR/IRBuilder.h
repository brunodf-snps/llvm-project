...
public:
  ...
  /// Create a llvm.provenance.noalias intrinsic call.
  Instruction *CreateProvenanceNoAliasPlain(Value *Ptr, Value *NoAliasDecl,
                                            Value *AddrP,
                                            Value *AddrP_Provenance,
  ...
  /// Create llvm.noalias_copy_guard intrinsics. Returns the BasePtr when no
  /// Offsets are provided.
  Value *CreateNoAliasCopyGuard(Value *BasePtr, Value *NoAliasDel,
