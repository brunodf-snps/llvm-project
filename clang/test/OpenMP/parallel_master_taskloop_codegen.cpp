...
// CHECK1-NEXT:    [[TMP19:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP5]], ptr [[TMP18]], ptr null, i64 0, metadata [[META13]]), !noalias [[META16:![0-9]+]]
// CHECK1-NEXT:    [[TMP20:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META19:![0-9]+]])
// CHECK1-NEXT:    [[TMP21:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP17]], ptr [[TMP20]], ptr null, i64 0, metadata [[META19]]), !noalias [[META16]]
// CHECK1-NEXT:    [[TMP22:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META20:![0-9]+]])
// CHECK1-NEXT:    [[TMP23:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP7]], ptr [[TMP22]], ptr null, i64 0, metadata [[META20]]), !noalias [[META16]]
// CHECK1-NEXT:    store i32 [[TMP2]], ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    store ptr [[TMP19]], ptr [[DOTPART_ID__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store ptr null, ptr [[DOTPRIVATES__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store ptr null, ptr [[DOTCOPY_FN__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store ptr [[TMP3]], ptr [[DOTTASK_T__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store i64 [[TMP9]], ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store i64 [[TMP11]], ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store i64 [[TMP13]], ptr [[DOTST__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store i32 [[TMP15]], ptr [[DOTLITER__ADDR_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    store ptr [[TMP21]], ptr [[DOTREDUCTIONS__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    store ptr [[TMP23]], ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    [[CONV_I:%.*]] = trunc i64 [[TMP25]] to i32
// CHECK1-NEXT:    store i32 [[CONV_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I:%.*]]
// CHECK1:       omp.inner.for.cond.i:
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    [[CONV1_I:%.*]] = sext i32 [[TMP26]] to i64
// CHECK1-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META16]]
// CHECK1-NEXT:    [[CMP_I:%.*]] = icmp ule i64 [[CONV1_I]], [[TMP27]]
// CHECK1-NEXT:    br i1 [[CMP_I]], label [[OMP_INNER_FOR_BODY_I:%.*]], label [[DOTOMP_OUTLINED__2_EXIT:%.*]]
// CHECK1:       omp.inner.for.body.i:
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    store i32 [[TMP28]], ptr [[I_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    [[ADD2_I:%.*]] = add nsw i32 [[TMP29]], 1
// CHECK1-NEXT:    store i32 [[ADD2_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META16]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// CHECK1-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[ARGC_ADDR]], align 8, !nonnull [[META21:![0-9]+]], !align [[META22:![0-9]+]]
// CHECK1-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[ARGV_ADDR]], align 8, !nonnull [[META21]], !align [[META23:![0-9]+]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASK_T]], ptr [[TMP4]], i32 0, i32 9
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP16]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META24:![0-9]+]])
// CHECK1-NEXT:    [[TMP19:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP5]], ptr [[TMP18]], ptr null, i64 0, metadata [[META24]]), !noalias [[META27:![0-9]+]]
// CHECK1-NEXT:    [[TMP20:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META30:![0-9]+]])
// CHECK1-NEXT:    [[TMP21:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP17]], ptr [[TMP20]], ptr null, i64 0, metadata [[META30]]), !noalias [[META27]]
// CHECK1-NEXT:    [[TMP22:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META31:![0-9]+]])
// CHECK1-NEXT:    [[TMP23:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP7]], ptr [[TMP22]], ptr null, i64 0, metadata [[META31]]), !noalias [[META27]]
// CHECK1-NEXT:    store i32 [[TMP2]], ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    store ptr [[TMP19]], ptr [[DOTPART_ID__ADDR_I]], align 8, !noalias [[META27]]
...
// CHECK1-NEXT:    store i64 [[TMP9]], ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store i64 [[TMP11]], ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store i64 [[TMP13]], ptr [[DOTST__ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store i32 [[TMP15]], ptr [[DOTLITER__ADDR_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    store ptr [[TMP21]], ptr [[DOTREDUCTIONS__ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store ptr [[TMP23]], ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[TMP25]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    store i32 [[TMP26]], ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    store i32 [[TMP28]], ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP29:%.*]] = getelementptr inbounds nuw [[STRUCT_ANON_2:%.*]], ptr [[TMP24]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[TMP29]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META23]]
// CHECK1-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[TMP30]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP32:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP32]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[IDXPROM_I:%.*]] = sext i32 [[TMP33]] to i64
// CHECK1-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds ptr, ptr [[TMP31]], i64 [[IDXPROM_I]]
// CHECK1-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[ARRAYIDX_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP35:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP36:%.*]] = load i32, ptr [[TMP35]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[IDXPROM4_I:%.*]] = sext i32 [[TMP36]] to i64
// CHECK1-NEXT:    [[ARRAYIDX5_I:%.*]] = getelementptr inbounds i8, ptr [[TMP34]], i64 [[IDXPROM4_I]]
// CHECK1-NEXT:    [[TMP37:%.*]] = load i8, ptr [[ARRAYIDX5_I]], align 1, !noalias [[META27]]
// CHECK1-NEXT:    [[CONV_I:%.*]] = sext i8 [[TMP37]] to i32
// CHECK1-NEXT:    store i32 [[CONV_I]], ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[CONV7_I:%.*]] = sext i32 [[TMP38]] to i64
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP40:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    store i64 [[SUB12_I]], ptr [[DOTCAPTURE_EXPR_6_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store i32 0, ptr [[I_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    store i32 [[TMP41]], ptr [[J_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP42:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    [[TMP43:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    [[TMP45:%.*]] = load i64, ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    store i64 [[TMP45]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP46:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP47:%.*]] = getelementptr inbounds nuw [[STRUCT_ANON_2]], ptr [[TMP24]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP48:%.*]] = load ptr, ptr [[TMP47]], align 8, !noalias [[META27]], !nonnull [[META21]], !align [[META23]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I:%.*]]
// CHECK1:       omp.inner.for.cond.i:
// CHECK1-NEXT:    [[TMP49:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP50:%.*]] = load i64, ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META27]]
...
// CHECK1:       omp.inner.for.body.i:
// CHECK1-NEXT:    [[TMP51:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP52:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP53:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    store i32 [[CONV26_I]], ptr [[I14_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP54:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[CONV27_I:%.*]] = sext i32 [[TMP54]] to i64
// CHECK1-NEXT:    [[TMP55:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP56:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP58:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_3_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP60:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META27]]
...
// CHECK1-NEXT:    store i32 [[CONV45_I]], ptr [[J15_I]], align 4, !noalias [[META27]]
// CHECK1-NEXT:    [[TMP61:%.*]] = load i64, ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    [[ADD46_I:%.*]] = add nsw i64 [[TMP61]], 1
// CHECK1-NEXT:    store i64 [[ADD46_I]], ptr [[DOTOMP_IV_I]], align 8, !noalias [[META27]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
...
// CHECK1-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASK_T]], ptr [[TMP4]], i32 0, i32 9
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP16]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META32:![0-9]+]])
// CHECK1-NEXT:    [[TMP19:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP5]], ptr [[TMP18]], ptr null, i64 0, metadata [[META32]]), !noalias [[META35:![0-9]+]]
// CHECK1-NEXT:    [[TMP20:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META38:![0-9]+]])
// CHECK1-NEXT:    [[TMP21:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP17]], ptr [[TMP20]], ptr null, i64 0, metadata [[META38]]), !noalias [[META35]]
// CHECK1-NEXT:    [[TMP22:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META39:![0-9]+]])
// CHECK1-NEXT:    [[TMP23:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP7]], ptr [[TMP22]], ptr null, i64 0, metadata [[META39]]), !noalias [[META35]]
// CHECK1-NEXT:    store i32 [[TMP2]], ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    store ptr [[TMP19]], ptr [[DOTPART_ID__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store ptr null, ptr [[DOTPRIVATES__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store ptr null, ptr [[DOTCOPY_FN__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store ptr [[TMP3]], ptr [[DOTTASK_T__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store i64 [[TMP9]], ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store i64 [[TMP11]], ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store i64 [[TMP13]], ptr [[DOTST__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store i32 [[TMP15]], ptr [[DOTLITER__ADDR_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    store ptr [[TMP21]], ptr [[DOTREDUCTIONS__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    store ptr [[TMP23]], ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    [[CONV_I:%.*]] = trunc i64 [[TMP25]] to i32
// CHECK1-NEXT:    store i32 [[CONV_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I:%.*]]
// CHECK1:       omp.inner.for.cond.i:
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    [[CONV1_I:%.*]] = sext i32 [[TMP26]] to i64
// CHECK1-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META35]]
// CHECK1-NEXT:    [[CMP_I:%.*]] = icmp ule i64 [[CONV1_I]], [[TMP27]]
// CHECK1-NEXT:    br i1 [[CMP_I]], label [[OMP_INNER_FOR_BODY_I:%.*]], label [[OMP_INNER_FOR_END_I:%.*]]
// CHECK1:       omp.inner.for.body.i:
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    store i32 [[TMP28]], ptr [[I_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    [[TMP30:%.*]] = call i32 @__kmpc_cancel(ptr @[[GLOB1]], i32 [[TMP29]], i32 4), !noalias [[META35]]
...
// CHECK1-NEXT:    store i32 1, ptr [[CLEANUP_DEST_SLOT_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    br label [[DOTOMP_OUTLINED__8_EXIT:%.*]]
// CHECK1:       .cancel.continue.i:
// CHECK1-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    [[TMP33:%.*]] = call i32 @__kmpc_cancellationpoint(ptr @[[GLOB1]], i32 [[TMP32]], i32 4), !noalias [[META35]]
...
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    [[ADD4_I:%.*]] = add nsw i32 [[TMP35]], 1
// CHECK1-NEXT:    store i32 [[ADD4_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
// CHECK1:       omp.inner.for.end.i:
// CHECK1-NEXT:    store i32 0, ptr [[CLEANUP_DEST_SLOT_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    br label [[DOTOMP_OUTLINED__8_EXIT]]
// CHECK1:       .omp_outlined..8.exit:
// CHECK1-NEXT:    [[CLEANUP_DEST_I:%.*]] = load i32, ptr [[CLEANUP_DEST_SLOT_I]], align 4, !noalias [[META35]]
// CHECK1-NEXT:    ret i32 0
//
//
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[C_ADDR]], align 8, !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP4:%.*]] = call i32 @__kmpc_master(ptr @[[GLOB1]], i32 [[TMP3]])
// CHECK1-NEXT:    [[TMP5:%.*]] = icmp ne i32 [[TMP4]], 0
...
// CHECK1-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw [[STRUCT_KMP_TASK_T]], ptr [[TMP4]], i32 0, i32 9
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[TMP16]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META40:![0-9]+]])
// CHECK1-NEXT:    [[TMP19:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP5]], ptr [[TMP18]], ptr null, i64 0, metadata [[META40]]), !noalias [[META43:![0-9]+]]
// CHECK1-NEXT:    [[TMP20:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META46:![0-9]+]])
// CHECK1-NEXT:    [[TMP21:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP17]], ptr [[TMP20]], ptr null, i64 0, metadata [[META46]]), !noalias [[META43]]
// CHECK1-NEXT:    [[TMP22:%.*]] = call ptr @llvm.noalias.decl.p0.p0.i64(ptr null, i64 0, metadata [[META47:![0-9]+]])
// CHECK1-NEXT:    [[TMP23:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP7]], ptr [[TMP22]], ptr null, i64 0, metadata [[META47]]), !noalias [[META43]]
// CHECK1-NEXT:    store i32 [[TMP2]], ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    store ptr [[TMP19]], ptr [[DOTPART_ID__ADDR_I]], align 8, !noalias [[META43]]
...
// CHECK1-NEXT:    store ptr [[TMP21]], ptr [[DOTREDUCTIONS__ADDR_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    store ptr [[TMP23]], ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[__CONTEXT_ADDR_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP24]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    store ptr [[TMP_I]], ptr [[TMP1_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP26:%.*]] = getelementptr inbounds nuw [[STRUCT_ANON_6:%.*]], ptr [[TMP24]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[TMP26]], align 8, !noalias [[META43]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, ptr [[TMP27]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    store i32 [[TMP28]], ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[SUB3_I:%.*]] = sub nsw i32 [[TMP29]], 1
// CHECK1-NEXT:    store i32 [[SUB3_I]], ptr [[DOTCAPTURE_EXPR_2_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    store ptr [[A_I]], ptr [[TMP4_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[TMP4_I]], align 8, !noalias [[META43]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    store i32 0, ptr [[TMP30]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP31:%.*]] = load i32, ptr [[DOTCAPTURE_EXPR__I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[CMP_I:%.*]] = icmp slt i32 0, [[TMP31]]
// CHECK1-NEXT:    br i1 [[CMP_I]], label [[TASKLOOP_IF_THEN_I:%.*]], label [[DOTOMP_OUTLINED__10_EXIT:%.*]]
// CHECK1:       taskloop.if.then.i:
// CHECK1-NEXT:    store ptr [[A5_I]], ptr [[TMP6_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP32:%.*]] = load i64, ptr [[DOTLB__ADDR_I]], align 8, !noalias [[META43]]
// CHECK1-NEXT:    [[CONV_I:%.*]] = trunc i64 [[TMP32]] to i32
// CHECK1-NEXT:    store i32 [[CONV_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP33:%.*]] = getelementptr inbounds nuw [[STRUCT_ANON_6]], ptr [[TMP24]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP34:%.*]] = load ptr, ptr [[TMP33]], align 8, !noalias [[META43]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I:%.*]]
// CHECK1:       omp.inner.for.cond.i:
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[CONV7_I:%.*]] = sext i32 [[TMP35]] to i64
// CHECK1-NEXT:    [[TMP36:%.*]] = load i64, ptr [[DOTUB__ADDR_I]], align 8, !noalias [[META43]]
...
// CHECK1:       omp.inner.for.body.i:
// CHECK1-NEXT:    [[TMP37:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP38:%.*]] = load ptr, ptr [[TMP6_I]], align 8, !noalias [[META43]], !nonnull [[META21]], !align [[META22]]
// CHECK1-NEXT:    store i32 [[TMP37]], ptr [[TMP38]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32, ptr [[DOTOMP_IV_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    [[ADD9_I:%.*]] = add nsw i32 [[TMP39]], 1
// CHECK1-NEXT:    store i32 [[ADD9_I]], ptr [[DOTOMP_IV_I]], align 4, !noalias [[META43]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND_I]]
// CHECK1:       omp.inner.for.end.i:
