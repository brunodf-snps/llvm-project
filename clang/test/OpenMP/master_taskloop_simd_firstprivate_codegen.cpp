...
// CHECK: [[SIVAR:%.+]] = load i{{.+}}, ptr @{{.+}},
// CHECK: store i32 [[SIVAR]], ptr [[PRIVATE_SIVAR_REF]],
...
// CHECK: [[T_VAR:%.+]] = load i32, ptr %{{.+}}, align 128
// CHECK: store i32 [[T_VAR]], ptr [[PRIVATE_T_VAR_REF]], align 128
